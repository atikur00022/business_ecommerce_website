...
import {
    SaleCustomerDropDownRequest
} from "../../ApiRequest/Sale/SaleCustomerDropDownApiRequest.js";
import {useSelector} from "react-redux";
import {
    SaleProductDropDownRequest
} from "../../ApiRequest/Sale/SaleProductDropDownApiRequest.js";
import ValidationHelper from "../../utility/ValidationHelper.js";
import store from "../../redux/store/Store.js";
import {onChangeSaleInput, setRemoveSaleItemList, setSaleItemList} from "../../redux/stateSlice/saleSlice.js";
import {CreateSaleRequest} from "../../ApiRequest/Sale/CreateSaleApiRequest.js";
...
const SaleCreateUpdate = () => {
    ...
    const formSubmit = async (e) => {
        ...
        if(ValidationHelper.IsEmpty(saleFormValue.customerId)) {
            ValidationHelper.WarningToast("Customer is required!")
        }else if(ValidationHelper.IsEmpty(saleFormValue.vatTax)) {
            ValidationHelper.WarningToast("Vat/Tax is required!")
        }else if(ValidationHelper.IsEmpty(saleFormValue.shippingCost)) {
            ValidationHelper.WarningToast("Shipping cost is required!")
        }else if(ValidationHelper.IsEmpty(saleFormValue.grandTotal)) {
                    ...
                    if (res.status === "fail") {
                        ...
                        setTimeout(() => {
                            if (user["role"] === "superadmin") {
                                navigate("/superadminsalelist");
                                setLoading(false);
                            } else if (user["role"] === "admin") {
                                navigate("/adminsalelist");
                                setLoading(false);
                            } else if (user["role"] === "employee") {
                                navigate("/employeealelist");
                                setLoading(false);
                            } else {
    ...
    const removeCart = async (index) => {
        store.dispatch(setRemoveSaleItemList(index));
    }
                                ...
                                <div className="card shadow rounded pt-3 vh-100">
                                    <div className="card-body">
                                        <div className="container-fluid">
                                            <h4 className="fw-bold text-success mb-4">Create Sales</h4>
                                            <form onSubmit={formSubmit}>
                                                <div className="col-12 mb-3">
                                                    <label htmlFor="selectCustomer" className="form-label">Select
                                                        Customer</label>
                                                    <select
                                                        value={saleFormValue.customerId} onChange={(e) => {
                                                ...
                                                <div className="col-12 mb-3">
                                                    ...
                                                    <input
                                                        value={saleFormValue.vatTax} onChange={(e) => {
                                                        store.dispatch(onChangeSaleInput({
                                                            Name: "vatTax",
                                                            Value: e.target.value
                                                        }))
                                                ...
                                                <div className="col-12 mb-3">
                                                    ...
                                                    <input
                                                        value={saleFormValue.discount} onChange={(e) => {
                                                        store.dispatch(onChangeSaleInput({
                                                            Name: "discount",
                                                            Value: e.target.value
                                                        }))
                                                ...
                                                <div className="col-12 mb-3">
                                                    ...
                                                    <input
                                                        value={saleFormValue.otherCost} onChange={(e) => {
                                                        store.dispatch(onChangeSaleInput({
                                                            Name: "otherCost",
                                                            Value: e.target.value
                                                        }))
                                                ...
                                                <div className="col-12 mb-3">
                                                    <label htmlFor="shippingCost" className="form-label">Shipping
                                                        cost</label>
                                                    <input
                                                        value={saleFormValue.shippingCost} onChange={(e) => {
                                                        store.dispatch(onChangeSaleInput({
                                                            Name: "shippingCost",
                                                            Value: e.target.value
                                                        }))
                                                ...
                                                <div className="col-12 mb-3">
                                                    <label htmlFor="grandTotal" className="form-label">Grand
                                                        total</label>
                                                    <input
                                                        value={saleFormValue.grandTotal} onChange={(e) => {
                                                        store.dispatch(onChangeSaleInput({
                                                            Name: "grandTotal",
                                                            Value: e.target.value
                                                        }))
                                                ...
                                                <div className="col-12 mb-3">
                                                    ...
                                                    <input
                                                        value={saleFormValue.note} onChange={(e) => {
                                                        store.dispatch(onChangeSaleInput({
                                                            Name: "note",
                                                            Value: e.target.value
                                                        }))
