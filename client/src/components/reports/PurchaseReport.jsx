...
import {PurchaseReportApiRequest} from "../../ApiRequest/Report/PurchaseReportApiRequest.js";
...
const PurchaseReport = () => {
    ...
    let dataList = useSelector((state) => state.report.purchaseReportByDateList);
    ...
    const formSubmit = async (e) => {
        ...
        if (ValidationHelper.IsEmpty(formRefValue)) {
            ...
            try {
                ...
                const res = await PurchaseReportApiRequest(formRefValue, toRefValue);
                        ...
                        <div className="container-fluid">
                            <div className="card shadow p-4">
                                <div className="card-body">
                                    <h5 className="card-title fs-2 fw-medium text-success">Purchase Report By Date</h5>
