...
import {ExpenseReportApiRequest} from "../../ApiRequest/Report/ExpenseReportApiRequest.js";
...
const ExpenseReport = () => {
    ...
    let dataList = useSelector((state) => state.report.expenseReportByDateList);
    ...
    const formSubmit = async (e) => {
        ...
        if (ValidationHelper.IsEmpty(formRefValue)) {
            ...
            try {
                ...
                const res = await ExpenseReportApiRequest(formRefValue, toRefValue);
            ...
            console.log('check expense report date', formRefValue);
            console.log('check expense report date', toRefValue);
                        ...
                        <div className="container-fluid">
                            <div className="card shadow p-4">
                                <div className="card-body">
                                    <h5 className="card-title fs-2 fw-medium text-success">Expense Report By Date</h5>
