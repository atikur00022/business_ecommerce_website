...
import {ReturnReportApiRequest} from "../../ApiRequest/Report/ReturnReportApiRequest.js";
...
const ReturnReport = () => {
    ...
    let dataList = useSelector((state) => state.report.returnReportByDateList);
    ...
    const formSubmit = async (e) => {
        ...
        if (ValidationHelper.IsEmpty(formRefValue)) {
            ...
            try {
                ...
                const res = await ReturnReportApiRequest(formRefValue, toRefValue);
                        ...
                        <div className="container-fluid">
                            <div className="card shadow p-4">
                                <div className="card-body">
                                    <h5 className="card-title fs-2 fw-medium text-success">Return Report By Date</h5>
