...
const Menu = () => {
    return (
        <section className="menu py-2 shadow bg-light sticky-top">
            <hr className="m-0"/>
                            ...
                            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                    <li className="nav-item">
                                        <NavLink to='/' className={({isActive}) => isActive ? 'menuActive' : 'pending'}
                                                 aria-current="page">Home</NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to='/grocery'
                                                 className={({isActive}) => isActive ? 'menuActive' : 'pending'}
